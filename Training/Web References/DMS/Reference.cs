...
namespace Training.DMS {
    ...
    public partial class DMS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public DMS() {
            this.Url = global::Training.Properties.Settings.Default.Training_DMS_DMS;
        ...
        public string AddNewDoc(string token, string folderId, string docName, string fileName, bool isPublish, string fileGroupId, string keyword, string DOC_SERIAL, string docClass, string DOC_COMMENT, string account, string version, string PUBLISH_UNIT) {
        ...
        /// <remarks/>
        public void AddNewDocAsync(string token, string folderId, string docName, string fileName, bool isPublish, string fileGroupId, string keyword, string DOC_SERIAL, string docClass, string DOC_COMMENT, string account, string version, string PUBLISH_UNIT) {
            this.AddNewDocAsync(token, folderId, docName, fileName, isPublish, fileGroupId, keyword, DOC_SERIAL, docClass, DOC_COMMENT, account, version, PUBLISH_UNIT, null);
        }
        
        /// <remarks/>
        public void AddNewDocAsync(string token, string folderId, string docName, string fileName, bool isPublish, string fileGroupId, string keyword, string DOC_SERIAL, string docClass, string DOC_COMMENT, string account, string version, string PUBLISH_UNIT, object userState) {
            ...
            this.InvokeAsync("AddNewDoc", new object[] {
                        ...
                        account,
                        version,
                        PUBLISH_UNIT}, this.AddNewDocOperationCompleted, userState);
        }
